...
void shopping :: menu(){
    ...
    switch(choice)
    {
        ...
        if(email=="ayush095@gmail.com" && password=="Ayush@2001"){
            administrator();
        }
        else{
...
void shopping::receipt(){
    ...
    if(!data){
        ...
        cout<<"\n\n_______________________________________RECEIPT______________________________________________\n";
        cout<<"\nProduct No\tproduct Name\tprod quant\tprice\tTotal Amount\tAmount with discount \n";
